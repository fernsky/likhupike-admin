...
export default function CreateBusiness() {
  ...
  const createMutation = api.business.createBusiness.useMutation({
    onSuccess: (data) => {
  ...
  const form = useForm({
    defaultValues: {
      ...
      statutoryStatus: "",
      statutoryStatusOther: "",
      panStatus: "",
      panNumber: "",

      // Employees
      hasPartners: "",
      totalPartners: undefined,
      nepaliMalePartners: undefined,
      nepaliFemalePartners: undefined,
      hasForeignPartners: "",
      foreignMalePartners: undefined,
      foreignFemalePartners: undefined,
      hasInvolvedFamily: "",
      totalInvolvedFamily: undefined,
      maleInvolvedFamily: undefined,
      femaleInvolvedFamily: undefined,

      // Permanent Employees
      hasPermanentEmployees: "",
      totalPermanentEmployees: undefined,
      nepaliMalePermanentEmployees: undefined,
      nepaliFemalePermanentEmployees: undefined,
      hasForeignPermanentEmployees: "",
      foreignMalePermanentEmployees: undefined,
      foreignFemalePermanentEmployees: undefined,

      // Temporary Employees
      hasTemporaryEmployees: "",
      totalTemporaryEmployees: undefined,
      nepaliMaleTemporaryEmployees: undefined,
      nepaliFemaleTemporaryEmployees: undefined,
      hasForeignTemporaryEmployees: "",
      foreignMaleTemporaryEmployees: undefined,
      foreignFemaleTemporaryEmployees: undefined,

      // Specialized Business
      aquacultureWardNo: undefined,
      pondCount: undefined,
      pondArea: undefined,
      fishProduction: undefined,
      fingerlingNumber: undefined,
      hasApiculture: "",
      apicultureWardNo: undefined,
      hiveCount: undefined,
      honeyProduction: undefined,
