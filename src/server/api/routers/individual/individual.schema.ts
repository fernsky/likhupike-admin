...
export const createIndividualSchema = z.object({
  ...
  wardNo: z.string().regex(/^\d+$/, "Ward number must be numeric").transform((val) => Number(val)),
  deviceId: z.string().optional(),
  name: z.string().min(1, "Name is required"),
  gender: z.string().min(1, "Gender is required"),
  age: z.string().regex(/^\d+$/, "Age must be numeric").transform((val) => Number(val)),
  ...
  marriedAge: z.string().regex(/^\d+$/, "Married age must be numeric").transform((val) => Number(val)).optional(),
...
export const updateIndividualSchema = z.object({
  ...
  wardNo: z.string().regex(/^\d+$/, "Ward number must be numeric").transform((val) => Number(val)).optional(),
  deviceId: z.string().optional(),
  name: z.string().min(1, "Name is required").optional(),
  gender: z.string().min(1, "Gender is required").optional(),
  age: z.string().regex(/^\d+$/, "Age must be numeric").transform((val) => Number(val)).optional(),
  familyRole: z.string().optional(),
  citizenOf: z.string().optional(),
  citizenOfOther: z.string().optional(),
  caste: z.string().optional(),
